...
ggplot(expdata, aes(x=Elapsed, y=Norm_Ratio, color=Treatment)) + 
  ...
  geom_smooth(data=expdata, aes(x=Elapsed, y=Norm_Ratio, color=Treatment), method='gam')

ggplot(expdata, aes(x=Elapsed, y=Norm_Ratio, color=Treatment)) + 
  geom_point(alpha=.2, size=.5) + 
  geom_line(data=expsum2, aes(x=Elapsed, y=Mean_Ratio, color=Treatment)) + 
  geom_errorbar(data=expsum2, aes(x=Elapsed, y=Mean_Ratio, color=Treatment, ymax=Mean_Ratio+SD, ymin=Mean_Ratio-SD))
